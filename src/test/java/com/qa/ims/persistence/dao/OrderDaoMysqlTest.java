...
//	
	...
	public void createTest() {
		...
		customerDaoMysql.create(new Customer("Matt", "Garbett"));
	...
	public void readAllTest() {
		...
		List<Integer> quantitems = new ArrayList<>();
		quantitems.add(20);
		List<Integer> quantitems2 = new ArrayList<>();
		quantitems2.add(20);
		orders.add(new Order(1L, 1L, items_id, "October").quantitems(quantitems));
		orders.add(new Order(2L, 2L, items_id2, "September").quantitems(quantitems2));
		orderDaoMysql.create(new Order(1L, items_id, "October").quantitems(quantitems));
		orderDaoMysql.create(new Order(2L, items_id2, "September").quantitems(quantitems2));
